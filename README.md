...
The **original git link**  http://https://links.mead.io/budget-app ==>  https://github.com/andrewjmead/react-course-2-expensify-app 
**does not build** anymore. (`npm install` leads to errors)
